...
var $author$project$Main$HonourHanzi = {$: 'HonourHanzi'};
...
var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$HonourHanzi,
			$elm$url$Url$Parser$s('honour-hanzi'))
		]));
...
var $author$project$Main$topMenu = function (model) {
	return A2(
		...
		A2(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('dropdownMenuLink'),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$src('https://s3.eu-central-1.amazonaws.com/bootstrapbaymisc/blog/24_days_bootstrap/fox.jpg'),
								...
								_List_fromArray(
									[
										...
										A2($elm$html$Html$Attributes$attribute, 'aria-labelledby', 'dropdownMenuLink')
									]),
								_List_fromArray(
									[
										A2(
			...
			A3(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Real World Mandarin')
					]),
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$topMenu(model),
